  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.message || "ID Buku sudah ada!");
      }
      ...
      Swal.fire({
        icon: 'success',
        title: 'Berhasil!',
        text: editingBook ? 'Buku berhasil diupdate!' : 'Buku berhasil ditambahkan!'
      });
    } catch (error) {
      ...
      Swal.fire({
        icon: 'error',
        title: 'Gagal!',
        text: error.message || 'Terjadi kesalahan saat menyimpan buku.'
      });
    }
  };
