...
function Admin() {
    ...
    return (
        <div className="p-10">
            ...
            <h2 className="text-2xl font-bold mt-10">Daftar Buku</h2>
            ...
            <h2 className="text-2xl font-bold mt-10">Penerbit</h2>
            <PenerbitForm 
            ...
            <h2 className="text-2xl font-bold mt-10">Daftar Penerbit</h2>
            <div className="bg-white border-2 border-black rounded-xl p-5 shadow-lg mt-4 overflow-auto">
                <table className="w-full border-collapse">
                    <thead>
                        <tr className="bg-[border-b-2 border-black">
                    ...
                    <tbody>
                        {publishers.map((pub) => (
                            <tr key={pub.id} className="text-center border-t border-black">
                                ...
                                <td className="p-3 flex justify-center gap-2">
                                    <button onClick={() => editPublisher(pub)} className="bg-yellow-500 text-black px-3 py-1 rounded-full border-2 border-black">Edit</button>
                                    <button onClick={() => deletePublisher(pub.id)} className="bg-red-500 text-white px-3 py-1 rounded-full border-2 border-black">Hapus</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
